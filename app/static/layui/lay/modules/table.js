...
layui.define(['laytpl', 'laypage', 'layer', 'form'], function(exports) {
    ...
    Class.prototype.render = function() {
        ...
        // 表格宽度自适应开始
        if (options.cols[0] !== undefined) {
            var cols_width_count = options.cols[0].length,
                cols_width_sum = 0,
                elem_width = options.width ? options.width : options.elem.parent().width();
            ...
            var cols_width_fix = parseInt((elem_width - 13 - cols_width_sum) / cols_width_count);
            if (cols_width_fix > 0) {
